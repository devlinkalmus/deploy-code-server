...
export function plannerLogic(input: LogicInput, memory: Memory[]): LogicResponse | null {
  ...
  const responses = planningResponses[activeContext as keyof typeof planningResponses];
